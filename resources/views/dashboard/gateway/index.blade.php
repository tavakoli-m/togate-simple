                        ...
                        <tbody>
                            @foreach ($gateways as $gateway)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('dashboard.gateway.destroy', $gateway) }}" id="deleteForm"
                                            method="POST" style="text-align: left">
                                            @csrf
                                            @method('DELETE')
                                            <a href="{{ route('dashboard.gateway.edit', $gateway) }}"
                                                class="btn btn-sm btn-primary"><span><i class="fa fa-edit"></i></span></a>
                                            <button class="btn btn-sm btn-danger delete"><span><i
